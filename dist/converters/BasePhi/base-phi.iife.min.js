...
/**
     ...
     * @license GPL-3.0
     */return class extends h{#n=b("1.618033988749894848204586834365638117720309179805762862135448622705260462818902449707207204189391137484754088075386891752");constructor(...t){super(),this.converter={radix:2,bsEnc:0,bsDec:0},this.b10=new l(10,0,0),this.charsets.default=["0","1"],this.version="default",this.signed=!0,this.utils.validateArgs(t,!0),this.isMutable.integrity=!1}encode(t,...e){const r=this.utils.validateArgs(e),n=this.charsets[r.version];let i,s,o,a="";if(r.decimalMode){if(!Number.isFinite(t))throw new TypeError("When running the converter in 'decimal' mode, only input of type Number is allowed.");t<0?(s=!0,o=b(-t)):(s=!1,o=b(t))}else[i,s]=this.utils.inputHandler.toBytes(t,r),o=b(this.b10.encode(i,null,r.littleEndian)[0]);if(o.eq(0)||o.eq(1))return a=n[o.toNumber()],s&&(a=`-${a}`),a;const l=[],h=[];let u=b(1),c=this.#n,f=0;for(;c.lt(o);)[u,c]=this.#i(u,c),f++;const d=(t,e,r)=>{if(!this.#s(o)){for(;t.gt(o);){if([t,e]=this.#o(t,e),t.lte(0))return void console.warn("Could not find an exact base-phi representation. Value is approximated.");r--}r>-1?l.unshift(r):h.push(r),o=o.minus(t),d(t,e,r)}};return d(u,c,f),f=0,l.forEach((t=>{for(;f<t;)a=`${n[0]}${a}`,f++;a=`${n[1]}${a}`,f++})),a?a+=".":a="0.",f=-1,h.forEach((t=>{for(;f>t;)a+=n[0],f--;a+=n[1],f--})),s&&(a=`-${a}`),a}decode(t,...e){const r=this.utils.validateArgs(e),n=this.charsets[r.version];let i;[t,i]=this.utils.extractSign(this.utils.normalizeInput(t));const[s,a]=t.split(".");let l=b(0),h=this.#n.minus(1),u=b(1);if([...s].reverse().forEach((t=>{const e=n.indexOf(t);if(1===e)l=l.plus(u);else if(0!==e)throw new o(t);[h,u]=this.#i(h,u)})),a){let t=b(1);u=this.#n.minus(t),[...a].forEach((e=>{const r=n.indexOf(e);if(1===r)l=l.plus(u);else if(0!==r)throw new o(e);[u,t]=this.#o(u,t)}))}if(r.decimalMode)return l.toNumber();l=l.round().toFixed();const c=this.b10.decode(l,[..."0123456789"],[],r.integrity,r.littleEndian);return this.utils.outputHandler.compile(c,r.outputType,r.littleEndian,i)}#s(t){return!t.round(50).abs().toNumber()}#i(t,e){return[e,t.plus(e)]}#o(t,e){return[e.minus(t),t]}}}();
