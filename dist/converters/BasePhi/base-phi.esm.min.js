 ...
 * @license MIT
 */class M extends h{#i=I("1.618033988749894848204586834365638117720309179805762862135448622705260462818902449707207204189391137484754088075386891752");constructor(...t){super(),this.converter={radix:2,bsEnc:0,bsDec:0},this.b10=new l(10,0,0),this.charsets.default=["0","1"],this.version="default",this.signed=!0,this.hasDecimalMode=!0,this.utils.validateArgs(t,!0)}encode(t,...e){const r=this.utils.validateArgs(e),i=this.charsets[r.version];let n,s,o,a="";if(r.decimalMode){if(!Number.isFinite(t))throw new TypeError("When running the converter in decimal-mode, only input of type 'Number' is allowed.");t<0?(s=!0,o=I(-t)):(s=!1,o=I(t))}else[n,s]=this.utils.inputHandler.toBytes(t,r),o=I(this.b10.encode(n,null,r.littleEndian)[0]);if(o.eq(0)||o.eq(1))return a=i[o.toNumber()],s&&(a=`-${a}`),a;const l=[],h=[];let u=I(1),c=this.#i,f=0;for(;c.lt(o);)[u,c]=this.#n(u,c),f++;const d=(t,e,r)=>{if(!this.#s(o)){for(;t.gt(o);){if([t,e]=this.#o(t,e),t.lte(0))return void console.warn("Could not find an exact base-phi representation. Value is approximated.");r--}r>-1?l.unshift(r):h.push(r),o=o.minus(t),d(t,e,r)}};return d(u,c,f),f=0,l.forEach((t=>{for(;f<t;)a=`${i[0]}${a}`,f++;a=`${i[1]}${a}`,f++})),a?a+=".":a="0.",f=-1,h.forEach((t=>{for(;f>t;)a+=i[0],f--;a+=i[1],f--})),s&&(a=`-${a}`),a}decode(t,...e){const r=this.utils.validateArgs(e),i=this.charsets[r.version];let n;if([t,n]=this.utils.extractSign(this.utils.normalizeInput(t)),!r.integrity){const e=[...i,"."];t=[...t].filter((t=>e.includes(t))).join("")}const s=t.split(".");if(r.integrity&&s.length>2)throw new o(null,"There are multiple decimal points in the input.");const[a,l]=s;let h=I(0),u=this.#i.minus(1),c=I(1);if([...a].reverse().forEach((t=>{const e=i.indexOf(t);if(1===e)h=h.plus(c);else if(0!==e)throw new o(t);[u,c]=this.#n(u,c)})),l){let t=I(1);c=this.#i.minus(t),[...l].forEach((e=>{const r=i.indexOf(e);if(1===r)h=h.plus(c);else if(0!==r)throw new o(e);[c,t]=this.#o(c,t)}))}if(r.decimalMode)return h.toNumber();h=h.round().toFixed();const f=this.b10.decode(h,[..."0123456789"],[],r.integrity,r.littleEndian);return this.utils.outputHandler.compile(f,r.outputType,r.littleEndian,n)}#s(t){return!t.round(50).abs().toNumber()}#n(t,e){return[e,t.plus(e)]}#o(t,e){return[e.minus(t),t]}}export{M as default};
