 ...
 * @license GPL-3.0
 */class Base64 extends BaseTemplate{constructor(...t){super(),this.converter=new BaseConverter(64,3,4),this.charsets.default=[..."ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"],this.padChars.default="=",this.charsets.urlsafe=this.charsets.default.slice(0,-2).concat(["-","_"]),this.padChars.urlsafe="=",this.padCharAmount=1,this.padding=!0,this.isMutable.padding=!0,this.utils.validateArgs(t,!0)}encode(t,...e){return super.encode(t,null,(({output:t,settings:e,zeroPadding:r})=>{if(r){const n=this.converter.padBytes(r),i=this.padChars[e.version].at(0);t=t.slice(0,-n),e.padding&&(t=t.concat(i.repeat(n)))}return t}),...e)}decode(t,...e){return super.decode(t,null,null,!1,...e)}}export{Base64 as default};
