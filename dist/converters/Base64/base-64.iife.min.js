...
/**
     ...
     * @license GPL-3.0
     */
return class extends class{constructor(t=!0){this.charsets={},this.hasSignedMode=!1,this.littleEndian=!1,this.numberMode=!1,this.outputType="buffer",this.padding=!1,this.signed=!1,this.upper=null,t&&(this.utils=new o(this)),this.version="default",this.isMutable={littleEndian:!1,padding:!1,signed:!1,upper:!1}}encode(t,e,n,...r){const i=this.utils.validateArgs(r);let s,o,a;[s,o,a]=this.utils.inputHandler.toBytes(t,i);let l=null;e&&(l=e(i));let[h,u]=this.converter.encode(s,this.charsets[i.version],i.littleEndian,l);return i.signed&&(h=this.utils.toSignedStr(h,o)),i.upper&&(h=h.toUpperCase()),n&&(h=n({inputBytes:s,output:h,settings:i,zeroPadding:u,type:a})),h}decode(t,e,n,...r){const i=this.utils.validateArgs(r);t=String(t);let s=!1;this.hasSignedMode&&([t,s]=this.utils.extractSign(t),s&&!i.signed&&this.utils.signError()),this.isMutable.upper&&(t=t.toLowerCase()),e&&(t=e({input:t,settings:i}));let o=this.converter.decode(t,this.charsets[i.version],i.littleEndian);return n&&(o=n({input:t,output:o,settings:i})),this.utils.outputHandler.compile(o,i.outputType,i.littleEndian,s)}}{constructor(...t){super();const e=[..."ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"];this.charsets.default=e.concat(["+","/"]),this.charsets.urlsafe=e.concat(["-","_"]),this.converter=new a(64,3,4),this.padding=!0,this.isMutable.padding=!0,this.utils.validateArgs(t,!0)}encode(t,...e){return super.encode(t,null,(t=>{let{output:e,settings:n,zeroPadding:r}=t;if(r){const t=this.converter.padBytes(r);e=e.slice(0,e.length-t),n.padding&&(e=e.concat("=".repeat(t)))}return e}),...e)}decode(t,...e){return super.decode(t,null,null,...e)}}}();
