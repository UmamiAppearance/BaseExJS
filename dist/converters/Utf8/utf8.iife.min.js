...
/**
     ...
     * @license GPL-3.0
     */return class extends h{constructor(...t){super(),this.converter=new l(10,0,0),this.charsets.default=[..."ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"],this.version="default",this.frozenCharsets=!0,this.utils.validateArgs(t,!0)}encode(t,...e){const n=this.utils.validateArgs(e),r=this.utils.inputHandler.toBytes(t,n)[0];let i=this.converter.encode(r,null,n.littleEndian)[0];return BigInt(i)}show(){}#r={a:1}}}();
