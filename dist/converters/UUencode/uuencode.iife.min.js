...
/**
     ...
     * @license MIT
     */const u=()=>{const t=()=>Math.floor(8*Math.random());return`${t()}${t()}${t()}`},c=()=>{const t=t=>t.at(Math.floor(Math.random()*t.length));return`${t(["unchronological","unconditionally","underemphasized","underprivileged","undistinguished","unsophisticated","untitled","untitled-1","untitled-3","uuencode"])}.${t(["applescript","bat","beam","bin","exe","js","mam","py","sh","vdo","wiz"])}`},f=t=>{const e=t/3*4;return e%4?4*Math.floor(e/4)+4:e};return class extends l{constructor(...t){super(),this.converter=new h(64,3,4),this.charsets.default=[..."`!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_"],Object.defineProperty(this.padChars,"default",{get:()=>[this.charsets.default.at(0)]}),this.charsets.original=[" ",...this.charsets.default.slice(1)],Object.defineProperty(this.padChars,"original",{get:()=>[this.charsets.original.at(0)]}),this.charsets.xx=[..."+-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"],Object.defineProperty(this.padChars,"xx",{get:()=>[this.charsets.xx.at(0)]}),this.padding=!0,this.buffering=!1,this.utils.converterArgs.buffering=["nobuffering","buffering"],this.isMutable.buffering=!0,this.header=!1,this.utils.converterArgs.header=["noheader","header"],this.isMutable.header=!0,this.isMutable.integrity=!1,this.utils.validateArgs(t,!0)}encode(t,...e){return super.encode(t,null,(({output:t,settings:e,zeroPadding:n})=>{const i=this.charsets[e.version],r=[...t],s=r.length;if(e.options.lineWrap=0,e.header&&!e.buffering){t=`begin ${e.options.permissions||u()} ${e.options.file||c()}\n`}else t="";for(let e=0;e<s;e+=60){const o=e+60,a=r.slice(e,o);if(o>=s){const e=this.converter.padChars(a.length)-n;t+=`${i.at(e)}${a.join("")}\n`}else t+=`${i.at(45)}${a.join("")}\n`}return e.buffering||(t+=`${i.at(0)}\n`,e.header&&(t+="end\n")),t}),...e)}decode(t,...e){let n=0;return super.decode(t,(({input:t,settings:e})=>{const i=this.charsets[e.version],r=t.trim().split(/\r?\n/),s=[];/^begin/i.test(r.at(0))&&r.shift();for(const t of r){const r=[...t],o=i.indexOf(r.shift());if(!(o>0))break;if(s.push(...r),45!==o){let t=r.length;if("original"===e.version){const e=f(o);for(;t<e;)t++,s.push(" ")}n=this.converter.padChars(t)-o;break}if(60!==r.length&&"original"===e.version)for(;s.length%60;)s.push(" ")}return s.join("")}),(({output:t})=>(n&&(t=new Uint8Array(t.slice(0,-n))),t)),!0,...e)}}}();
