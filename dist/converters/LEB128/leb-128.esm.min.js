 ...
 * @license MIT
 */class u extends h{constructor(...t){super(),this.converter=new l(10,0,0),this.hexlify=new l(16,1,2),this.charsets.default="<placeholder>",this.charsets.hex="<placeholder>",this.version="default",this.frozenCharsets=!0,this.littleEndian=!0,this.hasSignedMode=!0,this.isMutable.signed=!0,this.utils.validateArgs(t,!0)}encode(t,...e){const i=this.utils.validateArgs(e),n=i.signed;i.signed=!0;const[r,s]=this.utils.inputHandler.toBytes(t,i);let o=this.converter.encode(r,null,i.littleEndian)[0],a=BigInt(o),l=new Array;if(s){if(!n)throw new TypeError("Negative values in unsigned mode are invalid.");a=-a}if(n)for(;;){const t=Number(127n&a);if(a>>=7n,0==a&&0==(64&t)||-1==a&&0!=(64&t)){l.push(t);break}l.push(128|t)}else for(;;){const t=Number(127n&a);if(a>>=7n,0==a){l.push(t);break}l.push(128|t)}const h=Uint8Array.from(l);return"hex"===i.version?this.hexlify.encode(h,[..."0123456789abcdef"],!1)[0]:h}decode(e,...i){const n=this.utils.validateArgs(i);if("hex"===n.version)e=this.hexlify.decode(this.utils.normalizeInput(e).toLowerCase(),[..."0123456789abcdef"],[],n.integrity,!1);else{if(void 0===e.byteLength)throw new TypeError("Input must be a bytes like object.");e=t.toBytes(e)[0]}if(1===e.length&&!e[0])return this.utils.outputHandler.compile(new Uint8Array(1),n.outputType,!0);e=Array.from(e);let r,s,o,a=0n,l=-7n;for(r of e)l+=7n,a+=BigInt(127&r)<<l;n.signed&&0!=(64&r)&&(a|=-(1n<<l+7n)),[s,o]=this.utils.extractSign(a.toString());const h=this.converter.decode(s,[..."0123456789"],[],n.integrity,!0);return this.utils.outputHandler.compile(h,n.outputType,!0,o)}}export{u as default};
