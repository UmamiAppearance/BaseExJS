 ...
 * @license GPL-3.0
 */
class a extends class{constructor(t=!0){this.charsets={},this.hasSignedMode=!1,this.littleEndian=!1,this.numberMode=!1,this.outputType="buffer",this.padding=!1,this.signed=!1,this.upper=null,t&&(this.utils=new s(this)),this.version="default",this.isMutable={littleEndian:!1,padding:!1,signed:!1,upper:!1}}encode(t,e,n,...i){const r=this.utils.validateArgs(i);let s,o,a;[s,o,a]=this.utils.inputHandler.toBytes(t,r);let l,h,u=null;return e&&(u=e(r)),[l,h]=this.converter.encode(s,this.charsets[r.version],r.littleEndian,u),r.signed&&(l=this.utils.toSignedStr(l,o)),r.upper&&(l=l.toUpperCase()),n&&(l=n({inputBytes:s,output:l,settings:r,zeroPadding:h,type:a})),l}decode(t,e,n,...i){const r=this.utils.validateArgs(i);let s=String(t),o=!1;this.hasSignedMode&&([s,o]=this.utils.extractSign(s),o&&!r.signed&&this.utils.signError()),this.isMutable.upper&&(s=s.toLowerCase()),e&&(s=e({input:s,settings:r}));let a=this.converter.decode(s,this.charsets[r.version],r.littleEndian);return n&&(a=n({input:s,output:a,settings:r})),this.utils.outputHandler.compile(a,r.outputType,r.littleEndian,o)}}{constructor(...t){super(!1),this.charsets.default="<placeholder>",this.charsets.hex="<placeholder>",this.version="default",this.converter=new o(10,0,0),this.hexlify=new o(16,1,2),this.utils=new s(this,!1),this.littleEndian=!0,this.hasSignedMode=!0,this.isMutable.signed=!0,this.utils.validateArgs(t,!0)}encode(t,...e){const n=this.utils.validateArgs(e);let i,r;const s=n.signed;n.signed=!0,[i,r]=this.utils.inputHandler.toBytes(t,n);let o=this.converter.encode(i,null,n.littleEndian)[0],a=BigInt(o),l=new Array;if(r){if(!s)throw new TypeError("Negative values in unsigned mode are invalid.");a=-a}if(s)for(;;){const t=Number(127n&a);if(a>>=7n,0==a&&0==(64&t)||-1==a&&0!=(64&t)){l.push(t);break}l.push(128|t)}else for(;;){const t=Number(127n&a);if(a>>=7n,0==a){l.push(t);break}l.push(128|t)}const h=Uint8Array.from(l);return"hex"===n.version?this.hexlify.encode(h,"0123456789abcdef",!1)[0]:h}decode(t,...e){const n=this.utils.validateArgs(e);if("hex"===n.version?t=this.hexlify.decode(String(t).toLowerCase(),"0123456789abcdef",!1):t instanceof ArrayBuffer&&(t=new Uint8Array(t)),1===t.length&&!t[0])return this.utils.outputHandler.compile(new Uint8Array(1),n.outputType,!0);t=Array.from(t);let i,r,s,o=0n,a=-7n;for(i of t)a+=7n,o+=BigInt(127&i)<<a;n.signed&&0!=(64&i)&&(o|=-(1n<<a+7n)),[r,s]=this.utils.extractSign(o.toString());const l=this.converter.decode(r,"0123456789",!0);return this.utils.outputHandler.compile(l,n.outputType,!0,s)}}export{a as default};
