 ...
 * @license GPL-3.0
 */class u extends l{constructor(...t){super(),this.converter=new h(10,0,0),this.hexlify=new h(16,1,2),this.charsets.default="<placeholder>",this.charsets.hex="<placeholder>",this.version="default",this.frozenCharsets=!0,this.littleEndian=!0,this.hasSignedMode=!0,this.isMutable.signed=!0,this.utils.validateArgs(t,!0)}encode(t,...e){const n=this.utils.validateArgs(e);let i,r;const s=n.signed;n.signed=!0,[i,r]=this.utils.inputHandler.toBytes(t,n);let o=this.converter.encode(i,null,n.littleEndian)[0],a=BigInt(o),h=new Array;if(r){if(!s)throw new TypeError("Negative values in unsigned mode are invalid.");a=-a}if(s)for(;;){const t=Number(127n&a);if(a>>=7n,0==a&&0==(64&t)||-1==a&&0!=(64&t)){h.push(t);break}h.push(128|t)}else for(;;){const t=Number(127n&a);if(a>>=7n,0==a){h.push(t);break}h.push(128|t)}const l=Uint8Array.from(h);return"hex"===n.version?this.hexlify.encode(l,[..."0123456789abcdef"],!1)[0]:l}decode(e,...n){const i=this.utils.validateArgs(n);if("hex"===i.version)e=this.hexlify.decode(this.utils.normalizeInput(e).toLowerCase(),[..."0123456789abcdef"],[],i.integrity,!1);else{if(void 0===e.byteLength)throw new TypeError("Input must be a bytes like object.");e=t.toBytes(e)[0]}if(1===e.length&&!e[0])return this.utils.outputHandler.compile(new Uint8Array(1),i.outputType,!0);e=Array.from(e);let r,s,o,a=0n,h=-7n;for(r of e)h+=7n,a+=BigInt(127&r)<<h;i.signed&&0!=(64&r)&&(a|=-(1n<<h+7n)),[s,o]=this.utils.extractSign(a.toString());const l=this.converter.decode(s,[..."0123456789"],[],i.integrity,!0);return this.utils.outputHandler.compile(l,i.outputType,!0,o)}}export{u as default};
