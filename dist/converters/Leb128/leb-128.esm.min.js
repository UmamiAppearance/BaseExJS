 ...
 * @license GPL-3.0
 */class LEB128 extends BaseTemplate{constructor(...t){super(),this.converter=new BaseConverter(10,0,0),this.hexlify=new BaseConverter(16,1,2),this.charsets.default="<placeholder>",this.charsets.hex="<placeholder>",this.version="default",this.frozenCharsets=!0,this.littleEndian=!0,this.hasSignedMode=!0,this.isMutable.signed=!0,this.utils.validateArgs(t,!0)}encode(t,...e){const n=this.utils.validateArgs(e),r=n.signed;n.signed=!0;const[i,s]=this.utils.inputHandler.toBytes(t,n);let o=this.converter.encode(i,null,n.littleEndian)[0],a=BigInt(o),l=new Array;if(s){if(!r)throw new TypeError("Negative values in unsigned mode are invalid.");a=-a}if(r)for(;;){const t=Number(127n&a);if(a>>=7n,0==a&&0==(64&t)||-1==a&&0!=(64&t)){l.push(t);break}l.push(128|t)}else for(;;){const t=Number(127n&a);if(a>>=7n,0==a){l.push(t);break}l.push(128|t)}const h=Uint8Array.from(l);return"hex"===n.version?this.hexlify.encode(h,[..."0123456789abcdef"],!1)[0]:h}decode(t,...e){const n=this.utils.validateArgs(e);if("hex"===n.version)t=this.hexlify.decode(this.utils.normalizeInput(t).toLowerCase(),[..."0123456789abcdef"],[],n.integrity,!1);else{if(void 0===t.byteLength)throw new TypeError("Input must be a bytes like object.");t=BytesInput.toBytes(t)[0]}if(1===t.length&&!t[0])return this.utils.outputHandler.compile(new Uint8Array(1),n.outputType,!0);t=Array.from(t);let r,i,s,o=0n,a=-7n;for(r of t)a+=7n,o+=BigInt(127&r)<<a;n.signed&&0!=(64&r)&&(o|=-(1n<<a+7n)),[i,s]=this.utils.extractSign(o.toString());const l=this.converter.decode(i,[..."0123456789"],[],n.integrity,!0);return this.utils.outputHandler.compile(l,n.outputType,!0,s)}}export{LEB128 as default};
