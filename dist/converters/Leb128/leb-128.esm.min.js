 ...
 * @license GPL-3.0
 */
class l extends class{constructor(t=!0){this.charsets={},this.hasSignedMode=!1,this.integrity=!0,this.littleEndian=!1,this.numberMode=!1,this.outputType="buffer",this.padding=!1,this.padChars={default:""},this.signed=!1,this.upper=null,t&&(this.utils=new o(this)),this.version="default",this.isMutable={integrity:!0,littleEndian:!1,padding:!1,signed:!1,upper:!1}}encode(t,e,i,...n){const r=this.utils.validateArgs(n);let s,o,a;[s,o,a]=this.utils.inputHandler.toBytes(t,r);let l=null;e&&(l=e(r));let[h,u]=this.converter.encode(s,this.charsets[r.version],r.littleEndian,l);return r.signed&&(h=this.utils.toSignedStr(h,o)),r.upper&&(h=h.toUpperCase()),i&&(h=i({inputBytes:s,output:h,settings:r,zeroPadding:u,type:a})),h}decode(t,e,i,...n){const r=this.utils.validateArgs(n);t=String(t);let s=!1;this.hasSignedMode&&([t,s]=this.utils.extractSign(t),s&&!r.signed&&this.utils.signError()),this.isMutable.upper&&(t=t.toLowerCase()),e&&(t=e({input:t,settings:r}));let o=this.converter.decode(t,this.charsets[r.version],this.padChars[r.version],r.integrity,r.littleEndian);return i&&(o=i({input:t,output:o,settings:r})),this.utils.outputHandler.compile(o,r.outputType,r.littleEndian,s)}}{constructor(...t){super(!1),this.charsets.default="<placeholder>",this.padChars.default="",this.charsets.hex="<placeholder>",this.padChars.hex="",this.version="default",this.converter=new a(10,0,0),this.hexlify=new a(16,1,2),this.utils=new o(this,!1),this.littleEndian=!0,this.hasSignedMode=!0,this.isMutable.signed=!0,this.utils.validateArgs(t,!0)}encode(t,...e){const i=this.utils.validateArgs(e);let n,r;const s=i.signed;i.signed=!0,[n,r]=this.utils.inputHandler.toBytes(t,i);let o=this.converter.encode(n,null,i.littleEndian)[0],a=BigInt(o),l=new Array;if(r){if(!s)throw new TypeError("Negative values in unsigned mode are invalid.");a=-a}if(s)for(;;){const t=Number(127n&a);if(a>>=7n,0==a&&0==(64&t)||-1==a&&0!=(64&t)){l.push(t);break}l.push(128|t)}else for(;;){const t=Number(127n&a);if(a>>=7n,0==a){l.push(t);break}l.push(128|t)}const h=Uint8Array.from(l);return"hex"===i.version?this.hexlify.encode(h,[..."0123456789abcdef"],!1)[0]:h}decode(t,...e){const i=this.utils.validateArgs(e);if("hex"===i.version?t=this.hexlify.decode(String(t).toLowerCase(),[..."0123456789abcdef"],"",i.integrity,!1):t instanceof ArrayBuffer&&(t=new Uint8Array(t)),1===t.length&&!t[0])return this.utils.outputHandler.compile(new Uint8Array(1),i.outputType,!0);t=Array.from(t);let n,r,s,o=0n,a=-7n;for(n of t)a+=7n,o+=BigInt(127&n)<<a;i.signed&&0!=(64&n)&&(o|=-(1n<<a+7n)),[r,s]=this.utils.extractSign(o.toString());const l=this.converter.decode(r,[..."0123456789"],[],i.integrity,!0);return this.utils.outputHandler.compile(l,i.outputType,!0,s)}}export{l as default};
