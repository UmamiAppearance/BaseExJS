 ...
 * @license GPL-3.0
 */class u extends l{constructor(...t){super(),this.converter=new h(16,1,2),this.charsets.default=[..."0123456789abcdef"],this.padChars.default="",this.hasSignedMode=!0,this.isMutable.signed=!0,this.isMutable.upper=!0,this.utils.validateArgs(t,!0)}encode(t,...e){return super.encode(t,null,null,...e)}decode(t,...e){return super.decode(t,(({input:t})=>((t=t.replace(/^0x/,"")).length%2&&(t="0".concat(t)),t)),null,!1,...e)}}export{u as default};
