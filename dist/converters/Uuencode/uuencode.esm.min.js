 ...
 * @license GPL-3.0
 */class UUencode extends BaseTemplate{constructor(...t){super(),this.converter=new BaseConverter(64,3,4),this.charsets.default=[..."`!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_"],Object.defineProperty(this.padChars,"default",{get:()=>[this.charsets.default.at(0)]}),this.charsets.original=[" ",...this.charsets.default.slice(1)],Object.defineProperty(this.padChars,"original",{get:()=>[this.charsets.original.at(0)]}),this.charsets.xx=[..."+-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"],Object.defineProperty(this.padChars,"xx",{get:()=>[this.charsets.xx.at(0)]}),this.padding=!0,this.header=!1,this.utils.converterArgs.header=["noheader","header"],this.isMutable.header=!0,this.isMutable.integrity=!1,this.utils.validateArgs(t,!0)}encode(t,...e){return super.encode(t,null,(({output:t,settings:e,zeroPadding:n})=>{const r=this.charsets[e.version],i=[...t];if(e.header){t=`begin ${e.options.permissions||een()} ${e.options.file||ees()}\n`}else t="";for(;;){const e=i.splice(0,60);if(!i.length){const i=this.converter.padChars(e.length)-n;t+=`${r.at(i)}${e.join("")}\n`;break}t+=`${r.at(45)}${e.join("")}\n`}return t+=`${r.at(0)}\n`,e.header&&(t+="\nend"),t}),...e)}decode(t,...e){let n=0;return super.decode(t,(({input:t,settings:e})=>{const r=this.charsets[e.version],i=t.trim().split("\n"),s=[];/^begin/i.test(i.at(0))&&i.shift();for(const t of i){const e=[...t],i=r.indexOf(e.shift());if(!(i>0))break;if(s.push(...e),45!==i){n=this.converter.padChars(e.length)-i;break}}return s.join("")}),(({output:t})=>(n&&(t=new Uint8Array(t.slice(0,-n))),t)),!0,...e)}}const een=()=>{const t=()=>Math.floor(8*Math.random());return`${t()}${t()}${t()}`},ees=()=>{const t=t=>t.at(Math.floor(Math.random()*t.length));return`${t(["unchronological","unconditionally","underemphasized","underprivileged","undistinguished","unsophisticated","untitled","untitled-1","untitled-3","uuencode"])}.${t(["applescript","bat","beam","bin","exe","js","mam","py","sh","vdo","wiz"])}`};export{UUencode as default};
