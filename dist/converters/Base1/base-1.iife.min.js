...
/**
     ...
     * @license GPL-3.0
     */return class extends h{constructor(...t){super(),this.charsets.all=[..." !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~"],this.charsets.sequence=[..."Hello World!"],this.charsets.default=["1"],this.charsets.tmark=["|","#"],this.converter=new l(10,0,0),this.hasSignedMode=!0,this.littleEndian=!0,this.signed=!0,this.isMutable.charsets=!1,this.isMutable.signed=!0,this.isMutable.upper=!0,this.utils.validateArgs(t,!0)}encode(t,...e){const i=this.utils.validateArgs(e);let n,r;[n,r]=this.utils.inputHandler.toBytes(t,i);let s=this.converter.encode(n,null,i.littleEndian)[0],o=BigInt(s);if(o>Number.MAX_SAFE_INTEGER)throw new RangeError("Invalid string length.");o>16777216&&console.warn("The string length is really long. The JavaScript engine may have memory issues generating the output string."),o=Number(o);const a=this.charsets[i.version],l=a.length;let h="";if(1===l)h=a.at(0).repeat(o);else if("all"===i.version)for(let t=0;t<o;t++){h+=a[Math.floor(Math.random()*l)]}else if("tmark"===i.version){const t=o%5;o>4&&(h=a.at(1).repeat((o-t)/5)),h+=a.at(0).repeat(t)}else for(let t=0;t<o;t++)h+=a[t%l];return h=this.utils.toSignedStr(h,r),i.upper&&(h=h.toUpperCase()),this.utils.wrapOutput(h,i.options.lineWrap)}decode(t,...e){const i=this.utils.validateArgs(e);let n;if(t=this.utils.normalizeInput(t),[t,n]=this.utils.extractSign(t),"all"!==i.version){const e=[...new Set(this.charsets[i.version])].join(""),n=new RegExp(`[^${e}]`,"g");t=t.replace(n,"")}t=String(t.length);const r=this.converter.decode(t,[..."0123456789"],[],"",i.integrity,i.littleEndian);return this.utils.outputHandler.compile(r,i.outputType,i.littleEndian,n)}}}();
