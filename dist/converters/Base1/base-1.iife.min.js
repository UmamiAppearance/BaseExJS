...
/**
     ...
     * @license GPL-3.0
     */
class extends class{constructor(t=!0){this.charsets={},this.hasSignedMode=!1,this.littleEndian=!1,this.numberMode=!1,this.outputType="buffer",this.padding=!1,this.signed=!1,this.upper=null,t&&(this.utils=new o(this)),this.version="default",this.isMutable={littleEndian:!1,padding:!1,signed:!1,upper:!1}}encode(t,e,n,...i){const r=this.utils.validateArgs(i);let s,o,a;[s,o,a]=this.utils.inputHandler.toBytes(t,r);let l,h,u=null;return e&&(u=e(r)),[l,h]=this.converter.encode(s,this.charsets[r.version],r.littleEndian,u),r.signed&&(l=this.utils.toSignedStr(l,o)),r.upper&&(l=l.toUpperCase()),n&&(l=n({inputBytes:s,output:l,settings:r,zeroPadding:h,type:a})),l}decode(t,e,n,...i){const r=this.utils.validateArgs(i);let s=String(t),o=!1;this.hasSignedMode&&([s,o]=this.utils.extractSign(s),o&&!r.signed&&this.utils.signError()),this.isMutable.upper&&(s=s.toLowerCase()),e&&(s=e({input:s,settings:r}));let a=this.converter.decode(s,this.charsets[r.version],r.littleEndian);return n&&(a=n({input:s,output:a,settings:r})),this.utils.outputHandler.compile(a,r.outputType,r.littleEndian,o)}}{constructor(...t){super(),delete this.addCharset,this.charsets.all=" !\"#$%&'()*+,./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~",this.charsets.sequence="Hello World!",this.charsets.default="1",this.charsets.tmark="|#",this.converter=new a(10,0,0),this.hasSignedMode=!0,this.littleEndian=!0,this.signed=!0,this.isMutable.signed=!0,this.isMutable.upper=!0,this.utils.validateArgs(t,!0)}encode(t,...e){const n=this.utils.validateArgs(e);let i,r;[i,r]=this.utils.inputHandler.toBytes(t,n);let s=this.converter.encode(i,null,n.littleEndian)[0],o=BigInt(s);if(o>Number.MAX_SAFE_INTEGER)throw new RangeError("Invalid string length.");o>16777216&&this.utils.constructor.warning("The string length is really long. The JavaScript engine may have memory issues generating the output string."),o=Number(o);const a=this.charsets[n.version],l=a.length;let h="";if(1===l)h=a.repeat(o);else if("all"===n.version)for(let t=0;t<o;t++){h+=a[Math.floor(Math.random()*l)]}else if("tmark"===n.version){const t=o%5;o>4&&(h=a[1].repeat((o-t)/5)),h+=a[0].repeat(t)}else for(let t=0;t<o;t++)h+=a[t%l];return h=this.utils.toSignedStr(h,r),n.upper&&(h=h.toUpperCase()),h}decode(t,...e){const n=this.utils.validateArgs(e);let i;if(t=String(t),[t,i]=this.utils.extractSign(t),"all"!==n.version){const e=[...new Set(this.charsets[n.version])].join(""),i=new RegExp(`[^${e}]`,"g");t=t.replace(i,"")}t=String(t.length);const r=this.converter.decode(t,"0123456789",n.littleEndian);return this.utils.outputHandler.compile(r,n.outputType,n.littleEndian,i)}},Object.defineProperty(t,"__esModule",{value:!0}),t}({});
