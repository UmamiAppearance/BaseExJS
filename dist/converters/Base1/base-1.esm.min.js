 ...
 * @license GPL-3.0
 */class Base1 extends BaseTemplate{constructor(...t){super(),this.charsets.all=[..." !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~"],this.charsets.sequence=[..."Hello World!"],this.charsets.default=["1"],this.charsets.tmark=["|","#"],this.converter=new BaseConverter(10,0,0),this.hasSignedMode=!0,this.littleEndian=!0,this.signed=!0,this.isMutable.charsets=!1,this.isMutable.signed=!0,this.isMutable.upper=!0,this.utils.validateArgs(t,!0)}encode(t,...e){const n=this.utils.validateArgs(e);let r,i;[r,i]=this.utils.inputHandler.toBytes(t,n);let s=this.converter.encode(r,null,n.littleEndian)[0],o=BigInt(s);if(o>Number.MAX_SAFE_INTEGER)throw new RangeError("Invalid string length.");o>16777216&&console.warn("The string length is really long. The JavaScript engine may have memory issues generating the output string."),o=Number(o);const a=this.charsets[n.version],l=a.length;let h="";if(1===l)h=a.at(0).repeat(o);else if("all"===n.version)for(let t=0;t<o;t++){h+=a[Math.floor(Math.random()*l)]}else if("tmark"===n.version){const t=o%5;o>4&&(h=a.at(1).repeat((o-t)/5)),h+=a.at(0).repeat(t)}else for(let t=0;t<o;t++)h+=a[t%l];return h=this.utils.toSignedStr(h,i),n.upper&&(h=h.toUpperCase()),this.utils.wrapOutput(h,n.options.lineWrap)}decode(t,...e){const n=this.utils.validateArgs(e);let r;if(t=this.utils.normalizeInput(t),[t,r]=this.utils.extractSign(t),"all"!==n.version){const e=[...new Set(this.charsets[n.version])].join(""),r=new RegExp(`[^${e}]`,"g");t=t.replace(r,"")}t=String(t.length);const i=this.converter.decode(t,[..."0123456789"],[],"",n.integrity,n.littleEndian);return this.utils.outputHandler.compile(i,n.outputType,n.littleEndian,r)}}export{Base1 as default};
