 ...
 * @license GPL-3.0
 */
class h extends class{constructor(t=!0){this.charsets={},this.hasSignedMode=!1,this.integrity=!0,this.littleEndian=!1,this.numberMode=!1,this.outputType="buffer",this.padding=!1,this.padChars={default:""},this.signed=!1,this.upper=null,t&&(this.utils=new o(this)),this.version="default",this.isMutable={integrity:!0,littleEndian:!1,padding:!1,signed:!1,upper:!1}}encode(t,e,i,...r){const n=this.utils.validateArgs(r);let s,o,a;[s,o,a]=this.utils.inputHandler.toBytes(t,n);let h=null;e&&(h=e(n));let[l,u]=this.converter.encode(s,this.charsets[n.version],n.littleEndian,h);return n.signed&&(l=this.utils.toSignedStr(l,o)),n.upper&&(l=l.toUpperCase()),i&&(l=i({inputBytes:s,output:l,settings:n,zeroPadding:u,type:a})),l}decode(t,e,i,...r){const n=this.utils.validateArgs(r);t=String(t);let s=!1;this.hasSignedMode&&([t,s]=this.utils.extractSign(t),s&&!n.signed&&this.utils.signError()),this.isMutable.upper&&(t=t.toLowerCase()),e&&(t=e({input:t,settings:n}));let o=this.converter.decode(t,this.charsets[n.version],this.padChars[n.version],n.integrity,n.littleEndian);return i&&(o=i({input:t,output:o,settings:n})),this.utils.outputHandler.compile(o,n.outputType,n.littleEndian,s)}}{constructor(...t){super(),this.charsets.crockford=[..."0123456789abcdefghjkmnpqrstvwxyz"],this.padChars.crockford="=",this.charsets.rfc3548=[..."abcdefghijklmnopqrstuvwxyz234567"],this.padChars.rfc3548="=",this.charsets.rfc4648=[..."0123456789abcdefghijklmnopqrstuv"],this.padChars.rfc4648="=",this.charsets.zbase32=[..."ybndrfg8ejkmcpqxot1uwisza345h769"],this.padChars.zbase32="=",this.converter=new a(32,5,8),this.hasSignedMode=!0,this.version="rfc4648",this.isMutable.littleEndian=!0,this.isMutable.padding=!0,this.isMutable.signed=!0,this.isMutable.upper=!0,this.utils.validateArgs(t,!0),this.padding=/rfc3548|rfc4648/.test(this.version),this.upper="crockford"===this.version}encode(t,...e){return super.encode(t,null,(t=>{let{output:e,settings:i,zeroPadding:r}=t;if(!i.littleEndian&&r){const t=this.converter.padBytes(r);e=e.slice(0,e.length-t),i.padding&&(e=e.concat(this.padChars[i.version].repeat(t)))}return e}),...e)}decode(t,...e){return super.decode(t,null,null,...e)}}export{h as default};
