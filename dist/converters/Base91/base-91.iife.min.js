...
/**
     ...
     */
return class extends class{constructor(t=!0){this.charsets={},this.hasSignedMode=!1,this.littleEndian=!1,this.numberMode=!1,this.outputType="buffer",this.padding=!1,this.signed=!1,this.upper=null,t&&(this.utils=new s(this)),this.version="default",this.isMutable={littleEndian:!1,padding:!1,signed:!1,upper:!1}}encode(t,e,i,...n){const r=this.utils.validateArgs(n);let s,o,a;[s,o,a]=this.utils.inputHandler.toBytes(t,r);let u,l,h=null;return e&&(h=e(r)),[u,l]=this.converter.encode(s,this.charsets[r.version],r.littleEndian,h),r.signed&&(u=this.utils.toSignedStr(u,o)),r.upper&&(u=u.toUpperCase()),i&&(u=i({inputBytes:s,output:u,settings:r,zeroPadding:l,type:a})),u}decode(t,e,i,...n){const r=this.utils.validateArgs(n);let s=String(t),o=!1;this.hasSignedMode&&([s,o]=this.utils.extractSign(s),o&&!r.signed&&this.utils.signError()),this.isMutable.upper&&(s=s.toLowerCase()),e&&(s=e({input:s,settings:r}));let a=this.converter.decode(s,this.charsets[r.version],r.littleEndian);return i&&(a=i({input:s,output:a,settings:r})),this.utils.outputHandler.compile(a,r.outputType,r.littleEndian,o)}}{constructor(...t){super(),this.charsets.default=[...'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!#$%&()*+,./:;<=>?@[]^_`{|}~"'],this.utils.validateArgs(t,!0)}encode(t,...e){const i=this.utils.validateArgs(e),n=this.utils.inputHandler.toBytes(t,i)[0];let r=0,s=0,o="";const a=this.charsets[i.version];if(n.forEach((t=>{if(s+=t<<r,r+=8,r>13){let t,e,i=13,n=s%8192;n<89&&(i=14,n=s%16384),s>>=i,r-=i,[t,e]=this.divmod(n,91),o=`${o}${a[e]}${a[t]}`}})),r){let t,e;[t,e]=this.divmod(s,91),o=o.concat(a[e]),(r>7||s>90)&&(o=o.concat(a[t]))}return o}decode(t,...e){const i=this.utils.validateArgs(e);let n=(t=String(t)).length,r=!1;n%2&&(r=!0,n--);let s=0,o=0;const a=this.charsets[i.version],u=new Array;for(let e=0;e<n;e+=2){const i=a.indexOf(t[e])+91*a.indexOf(t[e+1]);s=(i<<o)+s,o+=i%8192>88?13:14;do{u.push(s%256),s>>=8,o-=8}while(o>7)}if(r){const e=t.charAt(n),i=a.indexOf(e);u.push(((i<<o)+s)%256)}const l=Uint8Array.from(u);return this.utils.outputHandler.compile(l,i.outputType)}divmod(t,e){return[Math.floor(t/e),t%e]}}}();
