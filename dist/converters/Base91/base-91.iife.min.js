...
/**
     ...
     */return class extends h{constructor(...t){super(),this.converter={radix:91,bsEnc:0,bsDec:0},this.charsets.default=[...'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!#$%&()*+,./:;<=>?@[]^_`{|}~"'],this.version="default",this.utils.validateArgs(t,!0),this.isMutable.integrity=!1}encode(t,...e){const n=this.utils.validateArgs(e),i=this.utils.inputHandler.toBytes(t,n)[0];let r=0,s=0,o="";const a=this.charsets[n.version];if(i.forEach((t=>{if(s+=t<<r,r+=8,r>13){let t,e,n=13,i=s%8192;i<89&&(n=14,i=s%16384),s>>=n,r-=n,[t,e]=this.#i(i,91),o=`${o}${a[e]}${a[t]}`}})),r){let t,e;[t,e]=this.#i(s,91),o=o.concat(a[e]),(r>7||s>90)&&(o=o.concat(a[t]))}return this.utils.wrapOutput(o,n.options.lineWrap)}decode(t,...e){const n=this.utils.validateArgs(e);t=this.utils.normalizeInput(t);const i=[...t];let r=i.length,s=!1;r%2&&(s=!0,r--);let a=0,h=0;const u=this.charsets[n.version],l=new Array;for(let t=0;t<r;t+=2){const e=u.indexOf(i[t]),n=u.indexOf(i[t+1]);if(e<0)throw new o(i[t]);if(n<0)throw new o(i[t+1]);const r=e+91*n;a=(r<<h)+a,h+=r%8192>88?13:14;do{l.push(a%256),a>>=8,h-=8}while(h>7)}if(s){const t=i.at(r),e=u.indexOf(t);l.push(((e<<h)+a)%256)}const c=Uint8Array.from(l);return this.utils.outputHandler.compile(c,n.outputType)}#i(t,e){return[Math.floor(t/e),t%e]}}}();
