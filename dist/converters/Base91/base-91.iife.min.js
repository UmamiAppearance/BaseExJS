...
/**
     ...
     */return class extends l{constructor(...t){super(),this.converter={radix:91,bsEnc:0,bsDec:0},this.charsets.default=[...'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!#$%&()*+,./:;<=>?@[]^_`{|}~"'],this.version="default",this.utils.validateArgs(t,!0),this.isMutable.integrity=!1}encode(t,...e){const i=this.utils.validateArgs(e),n=this.utils.inputHandler.toBytes(t,i)[0];let r=0,s=0,o="";const a=this.charsets[i.version];if(n.forEach((t=>{if(s+=t<<r,r+=8,r>13){let t,e,i=13,n=s%8192;n<89&&(i=14,n=s%16384),s>>=i,r-=i,[t,e]=this.#n(n,91),o=`${o}${a[e]}${a[t]}`}})),r){let t,e;[t,e]=this.#n(s,91),o=o.concat(a[e]),(r>7||s>90)&&(o=o.concat(a[t]))}return this.utils.wrapOutput(o,i.options.lineWrap)}decode(t,...e){const i=this.utils.validateArgs(e);t=this.utils.normalizeInput(t);const n=[...t];let r=n.length,s=!1;r%2&&(s=!0,r--);let a=0,l=0;const h=this.charsets[i.version],u=new Array;for(let t=0;t<r;t+=2){const e=h.indexOf(n[t]),i=h.indexOf(n[t+1]);if(e<0)throw new o(n[t]);if(i<0)throw new o(n[t+1]);const r=e+91*i;a=(r<<l)+a,l+=r%8192>88?13:14;do{u.push(a%256),a>>=8,l-=8}while(l>7)}if(s){const t=n.at(r),e=h.indexOf(t);u.push(((e<<l)+a)%256)}const c=Uint8Array.from(u);return this.utils.outputHandler.compile(c,i.outputType)}#n(t,e){return[Math.floor(t/e),t%e]}}}();
