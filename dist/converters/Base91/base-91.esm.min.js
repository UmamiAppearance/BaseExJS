 ...
 */class Base91 extends BaseTemplate{constructor(...t){super(),this.converter={radix:91,bsEnc:0,bsDec:0},this.charsets.default=[...'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!#$%&()*+,./:;<=>?@[]^_`{|}~"'],this.version="default",this.utils.validateArgs(t,!0),this.isMutable.integrity=!1}encode(t,...e){const r=this.utils.validateArgs(e),n=this.utils.inputHandler.toBytes(t,r)[0];let i=0,s=0,o="";const a=this.charsets[r.version];if(n.forEach((t=>{if(s+=t<<i,i+=8,i>13){let t,e,r=13,n=s%8192;n<89&&(r=14,n=s%16384),s>>=r,i-=r,[t,e]=this.#n(n,91),o=`${o}${a[e]}${a[t]}`}})),i){let t,e;[t,e]=this.#n(s,91),o=o.concat(a[e]),(i>7||s>90)&&(o=o.concat(a[t]))}return this.utils.wrapOutput(o,r.options.lineWrap)}decode(t,...e){const r=this.utils.validateArgs(e);t=this.utils.normalizeInput(t);const n=[...t];let i=n.length,s=!1;i%2&&(s=!0,i--);let o=0,a=0;const u=this.charsets[r.version],l=new Array;for(let t=0;t<i;t+=2){const e=u.indexOf(n[t]),r=u.indexOf(n[t+1]);if(e<0)throw new CharsetError(n[t]);if(r<0)throw new CharsetError(n[t+1]);const i=e+91*r;o=(i<<a)+o,a+=i%8192>88?13:14;do{l.push(o%256),o>>=8,a-=8}while(a>7)}if(s){const t=n.at(i),e=u.indexOf(t);l.push(((e<<a)+o)%256)}const h=Uint8Array.from(l);return this.utils.outputHandler.compile(h,r.outputType)}#n(t,e){return[Math.floor(t/e),t%e]}}export{Base91 as default};
