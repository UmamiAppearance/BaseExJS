...
/**
     ...
     * @license GPL-3.0
     */
return class extends class{constructor(t=!0){this.charsets={},this.hasSignedMode=!1,this.littleEndian=!1,this.numberMode=!1,this.outputType="buffer",this.padding=!1,this.signed=!1,this.upper=null,t&&(this.utils=new o(this)),this.version="default",this.isMutable={littleEndian:!1,padding:!1,signed:!1,upper:!1}}encode(t,e,n,...i){const r=this.utils.validateArgs(i);let s,o,a;[s,o,a]=this.utils.inputHandler.toBytes(t,r);let l=null;e&&(l=e(r));let[u,h]=this.converter.encode(s,this.charsets[r.version],r.littleEndian,l);return r.signed&&(u=this.utils.toSignedStr(u,o)),r.upper&&(u=u.toUpperCase()),n&&(u=n({inputBytes:s,output:u,settings:r,zeroPadding:h,type:a})),u}decode(t,e,n,...i){const r=this.utils.validateArgs(i);t=String(t);let s=!1;this.hasSignedMode&&([t,s]=this.utils.extractSign(t),s&&!r.signed&&this.utils.signError()),this.isMutable.upper&&(t=t.toLowerCase()),e&&(t=e({input:t,settings:r}));let o=this.converter.decode(t,this.charsets[r.version],r.littleEndian);return n&&(o=n({input:t,output:o,settings:r})),this.utils.outputHandler.compile(o,r.outputType,r.littleEndian,s)}}{constructor(...t){super(),this.charsets.default=[..."123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ"],this.charsets.bitcoin=[..."123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz"],this.charsets.flickr=[..."123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ"],this.converter=new a(58,0,0),this.padding=!0,this.version="bitcoin",this.isMutable.padding=!0,this.isMutable.signed=!0,this.utils.validateArgs(t,!0)}encode(t,...e){return super.encode(t,null,(t=>{let{inputBytes:e,output:n,settings:i,type:r}=t;if(i.padding&&"int"!==r){let t=0;const i=e.length;if(i){for(;!e[t];)if(t++,t===i){t=0;break}const r=t;r&&(n="1".repeat(r).concat(n))}}return n}),...e)}decode(t,...e){return super.decode(t,null,(t=>{let{input:e,output:n,settings:i}=t;if(i.padding&&e.length>1){let t=0;for(;"1"===e[t];)t++;const i=t;i&&(n=Uint8Array.from([...new Array(i).fill(0),...n]))}return n}),...e)}}}();
