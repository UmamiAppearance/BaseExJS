...
/**
     ...
     * @license GPL-3.0
     */
return class extends class{constructor(t=!0){this.charsets={},this.hasSignedMode=!1,this.integrity=!0,this.littleEndian=!1,this.numberMode=!1,this.outputType="buffer",this.padding=!1,this.padChars={default:""},this.signed=!1,this.upper=null,t&&(this.utils=new o(this)),this.version="default",this.isMutable={integrity:!0,littleEndian:!1,padding:!1,signed:!1,upper:!1}}encode(t,e,i,...n){const r=this.utils.validateArgs(n);let s,o,a;[s,o,a]=this.utils.inputHandler.toBytes(t,r);let l=null;e&&(l=e(r));let[h,u]=this.converter.encode(s,this.charsets[r.version],r.littleEndian,l);return r.signed&&(h=this.utils.toSignedStr(h,o)),r.upper&&(h=h.toUpperCase()),i&&(h=i({inputBytes:s,output:h,settings:r,zeroPadding:u,type:a})),h}decode(t,e,i,...n){const r=this.utils.validateArgs(n);t=String(t);let s=!1;this.hasSignedMode&&([t,s]=this.utils.extractSign(t),s&&!r.signed&&this.utils.signError()),this.isMutable.upper&&(t=t.toLowerCase()),e&&(t=e({input:t,settings:r}));let o=this.converter.decode(t,this.charsets[r.version],this.padChars[r.version],r.integrity,r.littleEndian);return i&&(o=i({input:t,output:o,settings:r})),this.utils.outputHandler.compile(o,r.outputType,r.littleEndian,s)}}{constructor(...t){super(),this.charsets.default=[..."123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ"],this.padChars.default=this.charsets.default[0],this.charsets.bitcoin=[..."123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz"],this.padChars.bitcoin=this.charsets.bitcoin[0],this.charsets.flickr=[..."123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ"],this.padChars.flickr=this.charsets.flickr[0],this.converter=new a(58,0,0),this.padding=!0,this.version="bitcoin",this.isMutable.padding=!0,this.isMutable.signed=!0,this.utils.validateArgs(t,!0)}encode(t,...e){return super.encode(t,null,(t=>{let{inputBytes:e,output:i,settings:n,type:r}=t;if(n.padding&&"int"!==r){let t=0;const r=e.length,s=this.charsets[n.version].at(0);if(r){for(;!e[t];)if(t++,t===r){t=0;break}const n=t;n&&(i=s.repeat(n).concat(i))}}return i}),...e)}decode(t,...e){return super.decode(t,null,(t=>{let{input:e,output:i,settings:n}=t;const r=this.charsets[n.version].at(0);if(n.padding&&e.length>1){let t=0;for(;e[t]===r;)t++;const n=t;n&&(i=Uint8Array.from([...new Array(n).fill(0),...i]))}return i}),...e)}}}();
