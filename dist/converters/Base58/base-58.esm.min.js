 ...
 * @license GPL-3.0
 */class Base58 extends BaseTemplate{constructor(...t){super(),this.converter=new BaseConverter(58,0,0),this.charsets.default=[..."123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ"],Object.defineProperty(this.padChars,"default",{get:()=>[this.charsets.default.at(0)]}),this.charsets.bitcoin=[..."123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz"],Object.defineProperty(this.padChars,"bitcoin",{get:()=>[this.charsets.bitcoin.at(0)]}),this.charsets.flickr=[..."123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ"],Object.defineProperty(this.padChars,"flickr",{get:()=>[this.charsets.flickr.at(0)]}),this.padding=!0,this.version="bitcoin",this.isMutable.padding=!0,this.isMutable.signed=!0,this.utils.validateArgs(t,!0)}encode(t,...e){return super.encode(t,null,(({inputBytes:t,output:e,settings:r,type:n})=>{if(r.padding&&"int"!==n){let n=0;const i=t.length,s=this.charsets[r.version].at(0);if(i){for(;!t[n];)if(n++,n===i){n=0;break}const r=n;r&&(e=s.repeat(r).concat(e))}}return e}),...e)}decode(t,...e){return super.decode(t,null,(({input:t,output:e,settings:r})=>{const n=this.charsets[r.version].at(0);if(r.padding&&t.length>1){let r=0;for(;t[r]===n;)r++;const i=r;i&&(e=Uint8Array.from([...new Array(i).fill(0),...e]))}return e}),!1,...e)}}export{Base58 as default};
