 ...
 */class ${constructor(t="buffer"){if(!n.typeList.includes(t)){let e=`Invalid argument '${t}' for output type. Allowed types are:\n`;throw e=e.concat(n.typeList.join(", ")),new TypeError(e)}this.base1=new u("default",t),this.base16=new d("default",t),this.base32_crockford=new p("rfc4648",t),this.base32_rfc3548=new p("rfc3548",t),this.base32_rfc4648=new p("rfc4648",t),this.base32_zbase32=new p("zbase32",t),this.base58=new f("default",t),this.base58_bitcoin=new f("bitcoin",t),this.base58_flickr=new f("flickr",t),this.base64=new g("default",t),this.base64_urlsafe=new g("urlsafe",t),this.uuencode=new b("default",t),this.xxencode=new b("xx",t),this.base85_adobe=new v("adobe",t),this.base85_ascii=new v("ascii85",t),this.base85_z85=new v("z85",t),this.base91=new m("default",t),this.leb128=new E("default",t),this.ecoji_v1=new A("emojis_v1",t),this.ecoji_v2=new A("emojis_v2",t),this.base2048=new T("default",t),this.byteConverter=new j(t),this.simpleBase={};for(let e=2;e<=62;e++)this.simpleBase[`base${e}`]=new x(e,t)}}export{u as Base1,d as Base16,T as Base2048,p as Base32,f as Base58,g as Base64,v as Base85,m as Base91,$ as BaseEx,j as ByteConverter,A as Ecoji,E as LEB128,x as SimpleBase,b as UUencode};
