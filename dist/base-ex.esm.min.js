 ...
 */class v{constructor(t="buffer"){if(!r.typeList.includes(t)){let e=`Invalid argument '${t}' for output type. Allowed types are:\n`;throw e=e.concat(r.typeList.join(", ")),new TypeError(e)}this.base1=new u("default",t),this.base16=new h("default",t),this.base32_crockford=new c("rfc4648",t),this.base32_rfc3548=new c("rfc3548",t),this.base32_rfc4648=new c("rfc4648",t),this.base32_zbase32=new c("zbase32",t),this.base58=new d("default",t),this.base58_bitcoin=new d("bitcoin",t),this.base58_flickr=new d("flickr",t),this.base64=new f("default",t),this.base64_urlsafe=new f("urlsafe",t),this.base85_adobe=new p("adobe",t),this.base85_ascii=new p("ascii85",t),this.base85_z85=new p("z85",t),this.base91=new g("default",t),this.leb128=new w("default",t),this.ecoji=new y("default"),this.byteConverter=new b(t),this.simpleBase={};for(let e=2;e<37;e++)this.simpleBase[`base${e}`]=new m(e,t)}}export{u as Base1,h as Base16,c as Base32,d as Base58,f as Base64,p as Base85,g as Base91,v as BaseEx,b as ByteConverter,y as Ecoji,w as LEB128,m as SimpleBase};
