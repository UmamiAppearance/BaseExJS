 ...
 */class D{constructor(t="buffer"){if(!n.typeList.includes(t)){let e=`Invalid argument '${t}' for output type. Allowed types are:\n`;throw e=e.concat(n.typeList.join(", ")),new TypeError(e)}this.base1=new u("default",t),this.base16=new d("default",t),this.base32_crockford=new f("rfc4648",t),this.base32_rfc3548=new f("rfc3548",t),this.base32_rfc4648=new f("rfc4648",t),this.base32_zbase32=new f("zbase32",t),this.base58=new p("default",t),this.base58_bitcoin=new p("bitcoin",t),this.base58_flickr=new p("flickr",t),this.base64=new g("default",t),this.base64_urlsafe=new g("urlsafe",t),this.uuencode=new w("default",t),this.xxencode=new w("xx",t),this.base85_adobe=new y("adobe",t),this.base85_ascii=new y("ascii85",t),this.base85_z85=new y("z85",t),this.base91=new m("default",t),this.leb128=new E("default",t),this.ecoji_v1=new A("emojis_v1",t),this.ecoji_v2=new A("emojis_v2",t),this.base2048=new x("default",t),this.byteConverter=new N(t),this.simpleBase={};for(let e=2;e<=62;e++)this.simpleBase[`base${e}`]=new M(e,t)}}export{u as Base1,d as Base16,x as Base2048,f as Base32,p as Base58,g as Base64,y as Base85,m as Base91,D as BaseEx,P as BasePhi,N as ByteConverter,A as Ecoji,E as LEB128,M as SimpleBase,w as UUencode};
