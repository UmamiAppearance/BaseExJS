...
/*
   ...
   */
class{constructor(t="buffer"){this.base16=new r("default",t),this.base32_rfc3548=new a("rfc3548",t),this.base32_rfc4648=new a("rfc4648",t),this.base64=new o("default",t),this.base64_urlsafe=new o("urlsafe",t),this.base85adobe=new l("adobe",t),this.base85ascii=new l("ascii85",t),this.base85_z85=new l("z85",t),this.base91=new h("default",t)}},t.SimpleBase=class{constructor(t,...i){if(!t||!Number.isInteger(t)||t<2||t>36)throw new RangeError("Radix argument must be provided and has to be an integer between 2 and 36.");this.charsets={selection:"0123456789abcdefghijklmnopqrstuvwxyz".substring(0,t)},this.converter=10===t?new e(10,0,0):new e(t),this.littleEndian=!(2===t||16===t),this.outputType="buffer",this.padding=!1,this.signed=!0,this.upper=!1,this.utils=new s(this),this.version="selection",this.isMutable={littleEndian:!1,padding:!1,signed:!1,upper:!0},this.utils.validateArgs(i,!0)}encode(t,...e){const s=this.utils.validateArgs(e);let i,n;[i,n]=this.utils.smartInput.toBytes(t,s.signed,s.littleEndian);let r=this.converter.encode(i,this.charsets[s.version],s.littleEndian)[0];return r=this.utils.toSignedStr(r,n),s.upper&&(r=r.toUpperCase()),r}decode(t,...e){const s=this.utils.validateArgs(e);let i;if(t=String(t),[t,i]=this.utils.extractSign(t),2===this.converter.radix){const e=(8-t.length%8)%8;t=`${"0".repeat(e)}${t}`}else if(16===this.converter.radix){const e=t.length%2;t=`${"0".repeat(e)}${t}`}console.log(t),t=t.toLowerCase();const n=this.converter.decode(t,this.charsets[s.version],s.littleEndian);return this.utils.smartOutput.compile(n,s.outputType,s.littleEndian,i)}},Object.defineProperty(t,"__esModule",{value:!0}),t}({});
