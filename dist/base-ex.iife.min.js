...
/**
     ...
     * @license MIT
     */return t.Base1=d,t.Base16=f,t.Base2048=M,t.Base32=p,t.Base58=g,t.Base64=b,t.Base85=E,t.Base91=A,t.BaseEx=class{constructor(t="buffer"){if(!o.typeList.includes(t)){let e=`Invalid argument '${t}' for output type. Allowed types are:\n`;throw e=e.concat(o.typeList.join(", ")),new TypeError(e)}this.base1=new d("default",t),this.base16=new f("default",t),this.base32_crockford=new p("rfc4648",t),this.base32_rfc3548=new p("rfc3548",t),this.base32_rfc4648=new p("rfc4648",t),this.base32_zbase32=new p("zbase32",t),this.base58=new g("default",t),this.base58_bitcoin=new g("bitcoin",t),this.base58_flickr=new g("flickr",t),this.base64=new b("default",t),this.base64_urlsafe=new b("urlsafe",t),this.uuencode=new w("default",t),this.uuencode_original=new w("original",t),this.xxencode=new w("xx",t),this.base85_adobe=new E("adobe",t),this.base85_ascii=new E("ascii85",t),this.base85_z85=new E("z85",t),this.base91=new A("default",t),this.leb128=new x("default",t),this.ecoji_v1=new T("emojis_v1",t),this.ecoji_v2=new T("emojis_v2",t),this.base2048=new M("default",t),this.basePhi=new P("default",t),this.byteConverter=new z(t),this.simpleBase={};for(let e=2;e<=62;e++)this.simpleBase[`base${e}`]=new B(e,t)}},t.BasePhi=P,t.ByteConverter=z,t.Ecoji=T,t.LEB128=x,t.SimpleBase=B,t.UUencode=w,t}({});
