...
/**
     ...
     * @author UmamiAppearance [mail@umamiappearance.eu]
     * @license GPL-3.0
     */class c extends u{constructor(...t){super(),this.converter=new l(16,1,2),this.charsets.default="0123456789abcdef",this.hasSignedMode=!0,this.isMutable.signed=!0,this.isMutable.upper=!0,this.utils.validateArgs(t,!0)}encode(t,...e){return super.encode(t,null,null,...e)}decode(t,...e){return super.decode(t,(t=>{let{input:e}=t;return e=e.replace(/^0x/,""),e.length%2&&(e="0".concat(e)),e}),null,...e)}}
/**
...
/*
     ...
     */return t.Base1=h,t.Base16=c,t.Base32=d,t.Base58=f,t.Base64=p,t.Base85=g,t.Base91=b,t.BaseEx=class{constructor(t="buffer"){if(!a.typeList.includes(t)){let e=`Invalid argument '${t}' for output type. Allowed types are:\n`;throw e=e.concat(a.typeList.join(", ")),new TypeError(e)}this.base1=new h("default",t),this.base16=new c("default",t),this.base32_crockford=new d("rfc4648",t),this.base32_rfc3548=new d("rfc3548",t),this.base32_rfc4648=new d("rfc4648",t),this.base32_zbase32=new d("zbase32",t),this.base58=new f("default",t),this.base58_bitcoin=new f("bitcoin",t),this.base58_flickr=new f("flickr",t),this.base64=new p("default",t),this.base64_urlsafe=new p("urlsafe",t),this.base85adobe=new g("adobe",t),this.base85ascii=new g("ascii85",t),this.base85_z85=new g("z85",t),this.base91=new b("default",t),this.leb128=new w("default",t),this.byteConverter=new y(t),this.simpleBase={};for(let e=2;e<37;e++)this.simpleBase[`base${e}`]=new m(e,t)}},t.ByteConverter=y,t.LEB128=w,t.SimpleBase=m,Object.defineProperty(t,"__esModule",{value:!0}),t}({});
