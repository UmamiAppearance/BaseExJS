...
/**
     ...
     */return t.Base1=d,t.Base16=f,t.Base2048=T,t.Base32=p,t.Base58=g,t.Base64=b,t.Base85=w,t.Base91=E,t.BaseEx=class{constructor(t="buffer"){if(!o.typeList.includes(t)){let e=`Invalid argument '${t}' for output type. Allowed types are:\n`;throw e=e.concat(o.typeList.join(", ")),new TypeError(e)}this.base1=new d("default",t),this.base16=new f("default",t),this.base32_crockford=new p("rfc4648",t),this.base32_rfc3548=new p("rfc3548",t),this.base32_rfc4648=new p("rfc4648",t),this.base32_zbase32=new p("zbase32",t),this.base58=new g("default",t),this.base58_bitcoin=new g("bitcoin",t),this.base58_flickr=new g("flickr",t),this.base64=new b("default",t),this.base64_urlsafe=new b("urlsafe",t),this.uuencode=new y("default",t),this.xxencode=new y("xx",t),this.base85_adobe=new w("adobe",t),this.base85_ascii=new w("ascii85",t),this.base85_z85=new w("z85",t),this.base91=new E("default",t),this.leb128=new A("default",t),this.ecoji_v1=new x("emojis_v1",t),this.ecoji_v2=new x("emojis_v2",t),this.base2048=new T("default",t),this.basePhi=new U("default",t),this.byteConverter=new D(t),this.simpleBase={};for(let e=2;e<=62;e++)this.simpleBase[`base${e}`]=new M(e,t)}},t.BasePhi=U,t.ByteConverter=D,t.Ecoji=x,t.LEB128=A,t.SimpleBase=M,t.UUencode=y,t}({});
